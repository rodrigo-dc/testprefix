...
STRING_MACRO_TEST_SET_NULL(ASSERT_STR_EQ)
STRING_MACRO_TEST_SET_NULL(ASSERT_STR_NE)
STRING_MACRO_TEST_SET_NULL(EXPECT_STR_EQ)
STRING_MACRO_TEST_SET_NULL(EXPECT_STR_NE)
